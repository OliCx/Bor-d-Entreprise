      ...
      <div className="content--container">
        <div className="content--row">
          <div className="content--image">
            <img src={beskæring} alt="service1" className="orson--img" />
          </div>
          <div className="content--text">
            <h1 className="content--title--left">Beskræring</h1>
            <p className="content--text">Beskæring af læhegn eller hækklipning med maskiner
vi har både store maskiner til det grove og små maskiner til det lidt finere.
</p>
          </div> 
        </div>
        <div className="content--row">
          <div className="content--text">
            <p className="content--text">Hvis der er enkeltstående stubbe i haven der skal fræses har vi stubfræser der kun er 90 cm. bred, så den kan komme ind i de fleste haver.
</p>
            <h1 className="content--title--right">Stubfræsning</h1>
          </div>
          <div className="content--image">
            <img src={stupfræsning} alt="service4" className="orson--img5" />
          </div> 
        </div>
       {/*  <div className="content--row">
        /*   <div className="content--text">
...
Gravemaskiner fra 8 ton og op lejes ikke ud uden fører.
        ...
        <div className="content--row">
          <div className="content--image">
            <img src={grenknusning} alt="service3" className="orson--img3" />
          </div>
          <div className="content--text">
            <h1 className="content--title--left">Grenknusning</h1>
            <p className="content--text">Vi tilbyder effektiv grenknusning af læhegn, jagt spor, juletræskulturer, buske og træstubbe og derefter rodfræsning, så arealet kan gendyrkes.</p>
          </div> 
        </div>
        <div className="content--row">
          <div className="content--text">
...
Gravemaskiner fra 8 ton og op lejes ikke ud uden fører.
            ...
            <h1 className="content--title--right">Maskinudlejning</h1>
          </div>
          <div className="content--image">
            <img src={maskiner} alt="service4" className="orson--img3" />
          </div> 
        </div>
        <div className="content--row">
          <div className="content--image">
            <img src={rodfræsning} alt="service3" className="orson--img2" />
          </div>
          <div className="content--text">
            <h1 className="content--title--left">Rodfræsning</h1>
            <p className="content--text">Vi tilbyder rodfræsning ned i 25-30 cm dybde så der efterfølgende er klar til plantning, såning af græs og korn. vi anbefaler i de fleste tilfælde at der grenknuses først så stubbe og grene bliver neddelt.</p>
          </div> 
        </div>
{/*         <div className="content--row">
          <div className="content--image">
