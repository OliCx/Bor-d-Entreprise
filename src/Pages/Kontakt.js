...
const Kontakt = (props) => {
  ...
  return (
    ...
    <div className="contact--container">
      <div className="contact--left"><img src={kontakt} alt="kontakt" className="boss"/></div>
      <div className="contact--right">
        <h1 className="contact--title">Kontakt</h1>        
        <p className="contact--text">+45 40 25 96 61</p>
        <p className="contact--text">borod.cb@gmail.com</p>
        <p className="contact--text">Nybyvej 103   
        4340 tølløse</p>
        <img src={map} alt="map" className="map" />
        <a href="https://www.facebook.com/" className="contact--text">Facebook</a>
      </div>
    </div>
    </div>
  );
