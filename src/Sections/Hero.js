            ...
            <div className='hero--container'>
                ...
                <img
                    className={`gravemaskinetest gravemaskinecrop  ${
                        imageRender === 2 ? 'rendered' : 'hidden'
                    } ${imageRender === 2 ? 'unzoomed' : 'zoomed'}`}
                    src={Forside1}
                />
                <img
                    className={`gravemaskinetest gravemaskinecrop  ${
                        imageRender === 3 ? 'rendered' : 'hidden'
                    } ${imageRender === 3 ? 'unzoomed' : 'zoomed'}`}
                    src={Forside7}
                />
                <img
                    className={`gravemaskinetest gravemaskinecrop ${
                        imageRender === 4 ? 'rendered' : 'hidden'
                    } ${imageRender === 4 ? 'unzoomed' : 'zoomed'}`}
                    src={Forside6}
                />
            </div>
        </div>
