  ...
  return (
    <div className="footer--container">
      <div className="footer--container--top">
        ...
        <div className="bb">
          <a href="https://www.facebook.com/" classname="bb">Facebook</a>
        </div>
        </div>
      ...
      <div className="footer--container--full">
        ...
        <Link to="/" className="nav--link notCurrent">Forside</Link>
       {/*  <Link to="/projekter" className="nav--link notCurrent">Projekter</Link> */}
        <Link to="/services" className="nav--link notCurrent">Vi udfører</Link>
        <Link to="/kontakt" className="nav--link notCurrent">Kontakt</Link>
        </div>
        </div>
    </div>
  );
