            ...
            <div className='gallery-container'>
                ...
                <div className='gallery-section'>
                    <div
                        ...
                        className='Maskinudlejning4'
                    ></div>
                </div>
                <div className='gallery-section'>
                    <div
                        onClick={(e) => lightBoxOpen(e, false)}
                        className='Maskinudlejning2'
                    ></div>
                </div>
                <div className='gallery-section'>
                    <div
                        onClick={(e) => lightBoxOpen(e, false)}
                        className='Maskinudlejning3'
                    ></div>
                </div>
                <div className='gallery-section'>
                    <div
                        onClick={(e) => lightBoxOpen(e, true)}
                        className='Maskinudlejning5'
                    ></div>
                </div>
                <div className='gallery-section'>
                    <div
                        onClick={(e) => lightBoxOpen(e, true)}
                        className='Maskinudlejning6'
                    ></div>
                </div>
                <div className='gallery-section'>
                    <div
                        onClick={(e) => lightBoxOpen(e, false)}
                        className='Maskinudlejning7'
                    ></div>
                </div>
                <div className='gallery-section'>
